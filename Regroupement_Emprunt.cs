...
namespace Easy_Book_Manager
{
    ...
    public partial class Regroupement_Emprunt : Form
    {
        ...
        private void Base()
        {
            try
            {
                //Netoyage des listbox et text pour les nouvelles requetes de la page Gerer Emprunt
                NomAdherent.Text = "";
                ...
                listeNom.Clear();
                //Netoyage des listbox/text de la page emprunt
                nAdherent.Text = "";
                pAdherent.Text = "";
                aAdherent.Text = "";
                tAdherent.Text = "";
        ...
        private void Regroupement_Emprunt_Load_1(object sender, EventArgs e)
        {
